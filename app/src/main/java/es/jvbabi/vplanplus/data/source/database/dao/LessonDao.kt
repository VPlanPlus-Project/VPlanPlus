...
abstract class LessonDao {
    ...
    abstract fun getLessonsByClass(classId: Long, timestamp: LocalDate): Flow<List<CLesson>>
    ...
    abstract fun getLessonsByTeacher(teacherId: Long, timestamp: LocalDate): Flow<List<CLesson>>
    ...
    abstract fun getLessonsByRoom(roomId: Long, timestamp: LocalDate): Flow<List<CLesson>>
