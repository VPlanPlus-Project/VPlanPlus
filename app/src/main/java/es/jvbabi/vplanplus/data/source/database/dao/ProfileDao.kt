...
abstract class ProfileDao {
    ...
    abstract suspend fun createClassProfile(id: UUID, name: String, customName: String, calendarMode: ProfileCalendarType, calendarId: Long?, classId: Int, isHomeworkEnabled: Boolean, vppId: Int?)
