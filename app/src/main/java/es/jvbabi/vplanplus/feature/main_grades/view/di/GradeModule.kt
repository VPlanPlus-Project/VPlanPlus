...
import es.jvbabi.vplanplus.feature.main_grades.view.domain.usecase.HideCalculationDisclaimerBannerUseCase
...
import es.jvbabi.vplanplus.feature.main_grades.view.domain.usecase.ShowCalculationDisclaimerBannerUseCase
...
object GradeModule {
    ...
    fun provideGradeUseCases(
        ...
        return GradeUseCases(
            ...
            showCalculationDisclaimerBannerUseCase = ShowCalculationDisclaimerBannerUseCase(keyValueRepository),
            hideCalculationDisclaimerBannerUseCase = HideCalculationDisclaimerBannerUseCase(keyValueRepository),
