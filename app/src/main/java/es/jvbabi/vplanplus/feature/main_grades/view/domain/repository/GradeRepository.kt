...
interface GradeRepository {
    ...
    suspend fun downloadGrades(activeVppId: VppId.ActiveVppId): Response<SchulverwalterResponse, List<Grade>?>
    ...
    suspend fun downloadYears(vppId: VppId.ActiveVppId): List<Year>
