package es.jvbabi.vplanplus.feature.main_homework.list_old.ui
...
import es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.HomeworkCard
import es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.HomeworkDisabled
import es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.NoHomework
import es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.WrongProfile
import es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.dialogs.ChangeVisibilityDialog
import es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.dialogs.DeleteHomeworkDialog
import es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.dialogs.DeleteHomeworkTaskDialog
...
fun HomeworkScreen(
    ...
    HomeworkScreenContent(
        ...
        onHomeworkClicked = {  navHostController.navigate(Screen.HomeworkDetailScreen.route + "/${it.id}") },
                                ...
                                label = {
                                    Text(
                                        text = stringResource(
                                            ...
                                            state.homework.count { (it as? Homework.CloudHomework)?.isHidden ?: false })
                                    )
                                },
                                leadingIcon = {
                                    Icon(
                    ...
                    LazyColumn(Modifier.fillMaxSize()) {
                        ...
                        items(list) { homeworkForDay ->
                            HomeworkCard(
                                ...
                                isOwner = (homeworkForDay is Homework.LocalHomework) || (homeworkForDay is Homework.CloudHomework && (state.profile as? ClassProfile)?.vppId == (homeworkForDay as? Homework.CloudHomework)?.createdBy),
                        ...
                        if (state.homework.none {
                                        (it is Homework.CloudHomework && (!it.isHidden || state.showHidden)) &&
