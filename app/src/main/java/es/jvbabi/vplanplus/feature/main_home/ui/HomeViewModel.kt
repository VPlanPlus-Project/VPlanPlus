...
import es.jvbabi.vplanplus.feature.main_home.domain.usecase.Date
    ...
    init {
        ...
        viewModelScope.launch {
            combine(
                ...
                var todayLessonExpanded = state.value.goToNextDay
                if (firstRun) {
                    todayLessonExpanded =
                ...
                state.value.copy(
                    ...
                    syncing = syncing,
                    bookings = bookings,
                    goToNextDay = todayLessonExpanded
                )
            }.collect {
                state.value = it
            }
