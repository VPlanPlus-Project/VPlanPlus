package es.jvbabi.vplanplus.feature.main_homework.list_old.ui.components.dialogs
...
private fun buildDialogMessage(homework: Homework): String {
    return if (homework is Homework.LocalHomework) {
        stringResource(id = R.string.homework_deleteHomeworkTextLocal)
    } else if ((homework as? Homework.CloudHomework)?.isPublic == true) {
